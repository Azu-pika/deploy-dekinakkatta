  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 px-4 max-w-4xl mx-auto">
        <h2 className="text-3xl font-klee font-semibold mb-6 text-center">Welcome to Our Ryokan</h2>
        <p className="text-lg font-klee text-gray-700 leading-relaxed mb-8">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-klee font-semibold mb-12 text-center">Featured Amenities</h2>
            ...
            {["Onsen Hot Springs", "Traditional Cuisine", "Zen Gardens"].map((amenity, index) => (
              <Card key={index} className="overflow-hidden">
                ...
                <CardContent className="p-4">
                  <h3 className="text-xl font-klee font-semibold mb-2">{amenity}</h3>
                  <p className="font-klee text-gray-600">Experience the essence of Japanese culture and relaxation.</p>
                </CardContent>
              </Card>
            ))}
          </div>
